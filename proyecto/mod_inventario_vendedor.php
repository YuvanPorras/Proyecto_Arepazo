<?php
//se llama a la base de datos y al verificador de inicio de sesion.
...
<header>
    ...
    <div class="card-body d-flex justify-content-between align-items-center">
      <div>
        <ul class="nav nav-pills " >
            <li class="nav-item">
            <a class="nav-link ayuda text-dark" href="ayuda_vendedor.php">Ayuda</a>
            </li>
        </ul>
    </div>
  ...
  <!---------- BUSCADOR ---------->
<div class="buscador">
    <form action="buscar_producto_vendedor.php" method="POST" onsubmit="return validarForm(this)">
